    ...
    async def print_results(dealer_hand, player_hand):
        ...
        await ctx.send("-"*30+"\n")
        await ctx.send("    \033[1;32;40mWINS:  \033[1;37;40m%s   \033[1;31;40mLOSSES:  \033[1;37;40m%s\n" % (wins, losses))
        await ctx.send("-"*30+"\n")
        await ctx.send("The dealer has a " + str(dealer_hand) + " for a total of " + str(total(dealer_hand)))
        await ctx.send("You have a " + str(player_hand) + " for a total of " + str(total(player_hand)))
